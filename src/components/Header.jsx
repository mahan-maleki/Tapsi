...
function Header() {
  return (
    <>
      <header>
        <div className='header grid grid-cols-4 items-center p-3'>
          ...
          <div className="nav grid-cols-4 col-span-3 gap-5 items-center hidden xl:grid">
          ...
          <div className="mobile-nav col-span-3 justify-items-end xl:hidden">
            <MobileMenu/>
          </div>
        </div>
      </header>
